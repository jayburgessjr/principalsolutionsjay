    ...
    <section className="article-hero">
      <div className="article-hero-inner">
        ...
        <div className="article-abstract">
          AI vendor evaluation is systematically compromised by the same dynamic
          ...
          operational reality behind the demo, identifies the questions that
          vendors are least prepared to answer honestly, and proposes a scoring
          framework that weights the factors that actually determine long-term
          vendor value.
        </div>
...
const EVAL_AREAS = [
  ...
  },
  {
    ...
    questions: [
      "What capabilities on the current roadmap are relevant to your use case, and on what timeline?",
      "What has shipped from the roadmap that was communicated at sales time in the past 12 months?",
      "How are customer requests prioritized, and what is the process for escalating a critical missing capability?",
      "What would cause the vendor to deprioritize or discontinue your use case?",
    ],
  },
];
            ...
            {e.questions.map((q, qi) => (
              <li
                ...
                style={{
                  ...
                  lineHeight: 1.7,
                  paddingLeft: "1rem",
                  borderLeft: "2px solid var(--orange-border)",
                }}
              >
                {q}
              </li>
    ...
    <div className="article-body">
      <div className="article-section reveal" ref={r1}>
        ...
        <div className="article-prose">
          <p>
            An AI vendor demo is a carefully engineered experience. The inputs
            are curated to showcase the system's strengths. The use cases are
          ...
          <p>
            None of this is deceptive in the conventional sense. It is standard
      ...
      <div className="article-section reveal" ref={r2}>
        ...
        <div className="article-prose">
          <p>
            The evaluation framework below covers five domains that collectively
            determine long-term vendor value. The questions within each domain
            are designed to produce specific, evidence-based answers rather than
            qualitative assurances. Select each domain to see the evaluation
            questions.
          </p>
        </div>
        <EvalTabs />
      ...
      <div className="article-section reveal" ref={r3}>
        ...
        <div className="article-prose">
          <p>
            The most revealing evaluation questions are the ones that require
            candid operational knowledge rather than prepared marketing
            responses. Bring your own data and ask the vendor to run their
            system on it, in a live evaluation rather than a prepared demo. Ask
            for the incident log from the past six months and walk through it
            together. Ask the sales team to describe a situation where their
            product was not the right choice for a customer and why.
          </p>
          <p>
            These questions reveal two things simultaneously: the actual
        ...
        <div className="article-pullquote">
          <p>
            "The vendor evaluation tells you what the product does. The
            conversation about what the product doesn't do tells you what kind
            of partner you're getting."
          </p>
        </div>
      </div>
      ...
      <div className="article-section reveal" ref={r4}>
        ...
        <div className="article-prose">
          ...
          <p>
            A vendor with 95% of the capability you need and excellent
            reliability, data governance, and support will consistently
          ...
          <p>
            The final evaluation weighting should reflect the long-term cost
      ...
      <div className="article-references">
        ...
        <ol>
          ...
          <li>
            ...
            <em>Competing on Analytics</em>. Harvard Business School Press.
          </li>
          <li>
            Thaler, R. H. &amp; Sunstein, C. R. (2008). <em>Nudge</em>. Yale
            University Press.
          </li>
        </ol>
      </div>
  ...
  return (
    <section className="cs-cta">
      <h3>
        ...
        <br />
        <span>and need an independent view?</span>
      </h3>
      <p>
        I've evaluated AI platforms across multiple industries. I can help you
        ask the questions the demo isn't designed to answer. Let's talk.
      </p>
      <a
