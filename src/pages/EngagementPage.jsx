    ...
    >
      ...
      <div className="cs-inner">
        <div className="cs-eyebrow">
          Engagement Models · Compensation Fit · Operator-Level Scope
        </div>
        ...
        <p className="cs-subtitle">
          Fractional leadership, fixed-scope diagnosis, and embedded build
          ownership.
        </p>
        <p className="cs-desc">
          The question is not whether I can architect the system. The question
          is what level of ownership you need: diagnosis, ongoing senior
          judgment, or someone who can go from root cause to shipped fix and
          leave behind the playbook.
        </p>
        <div className="cs-meta-bar">
          <div className="cs-meta-item">
            <div className="cmi-label">Advisory</div>
            <div className="cmi-val">
              Diagnostic sprints for high-leverage problems
            </div>
          </div>
          <div className="cs-meta-item">
    ...
    <section className="cs-section">
      <div className="cs-section-inner">
        ...
        <h2 className="cs-section-h2">
          ...
          <br />
          <em>Different scope. Same standard.</em>
        </h2>
  ...
  return (
    <section className="cs-section" style={{ background: "var(--panel)" }}>
      <div className="cs-section-inner">
        ...
        <h2 className="cs-section-h2">
          Worth in market terms.
          <br />
          <em>Positioned above a generic architect title.</em>
        </h2>
      ...
      <div className="cs-section-inner">
        ...
        <div className="proves-grid reveal" ref={ref}>
          <div className="proves-cell">
            ...
            <p>
              I find the actual failure mode instead of accepting the first
              explanation the organization gives me.
            </p>
          </div>
          <div
          ...
          >
            ...
            <p>
              I do not stop at architecture diagrams. I ship the system, the
              workflow, the data layer, or the tool itself.
            </p>
          </div>
          <div className="proves-cell">
            <div className="proves-cell-label">I hand off</div>
            <p>
              The output is a system and a playbook that continues to work after
              I leave, which is where the real leverage comes from.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <section className="cs-cta">
      <div className="cs-cta-inner">
        ...
        <p>
          The right engagement depends on how much ownership you need. If you
          want someone who can diagnose, build, and leave behind a system that
          runs, let’s talk.
        </p>
        <a
