    ...
    <section className="article-hero">
      <div className="article-hero-inner">
        <div className="article-eyebrow">
          Article · Data Infrastructure · April 2026
        </div>
        <h1 className="article-title">
          The Organizational Cost of Data Debt: How Unstructured Information
        ...
        <div className="article-abstract">
          ...
          structural pathways through which it erodes organizational capability,
          and proposes a remediation framework grounded in information
          architecture rather than data engineering. The central argument is
          that data debt is a leadership and governance problem before it is a
          technology problem.
        </div>
      ...
      <div className="debt-diagram">
        {DEBT_BARS.map((b) => (
          <div key={b.label} className="debt-bar-col">
            <div className="debt-bar" style={{ height: `${b.height}%` }} />
  ...
  return (
    <div className="article-body">
      ...
      <div className="article-section reveal" ref={r3}>
        ...
        <div className="article-prose">
          <p>
            <strong>Decision Latency.</strong> Organizations with significant
          ...
          <p>
            <strong>AI System Quality Ceiling.</strong> Increasingly,
            organizational data serves as the training and retrieval substrate
      ...
      <div className="article-section reveal" ref={r4}>
        ...
        <div className="article-prose">
          ...
          <p>
            Technology can make structured information more accessible. It
            cannot make unstructured information structured. It can improve
            retrieval from indexed data. It cannot index data that was never
            organized. It can accelerate analysis of clean, connected data. It
            cannot connect data that was never integrated.
          </p>
          <p>
            The governance failure that created the data debt does not disappear
      ...
      <div className="article-section reveal" ref={r5}>
        ...
        <div className="article-prose">
          <p>
            Effective remediation proceeds in three phases, each of which is a
          ...
          <p>
            ...
            architecture level. Organizations that skip this step select tools
            that are well-suited to the information architecture they wish they
          ...
          <p>
            Organizations that complete all three phases build the information
      ...
      <div className="article-references">
        ...
        <ol>
          ...
          <li>
            ...
            <em>Working Knowledge: How Organizations Manage What They Know</em>.
