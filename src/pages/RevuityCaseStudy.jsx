...
function Hero() {
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(ellipse 60% 70% at 100% 50%, rgba(232,98,26,0.07), transparent 70%)",
      }}
    >
      <div className="hero-bg-text">RS</div>
      <div className="cs-inner">
        <div className="cs-eyebrow">
          Case Study · Founder · AI-First Software Company
        </div>
        ...
        <p className="cs-subtitle">
          AI Advisory. Agentic Engineering. SaaS Products. PE Focus.
        </p>
        <p className="cs-desc">
        ...
        <div className="cs-meta-bar">
          ...
          <div className="cs-meta-item">
            ...
            <div className="cmi-val">
              Founder & Principal Forward Deployed Engineer
            </div>
          </div>
          <div className="cs-meta-item">
            <div className="cmi-label">Products Shipped</div>
            <div className="cmi-val">
              VoltIQ · PricingCopilot · MenuIQ · ROAAS
            </div>
          </div>
          <div className="cs-meta-item">
            <div className="cmi-label">Focus</div>
            <div className="cmi-val">
              AI Advisory · PE Firms · Agentic Engineering
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <section className="philosophy">
      <div className="philosophy-inner">
        <div className="section-label">The Company Philosophy</div>
        <h2>
          Not a Consulting Firm.
          <br />
          Not a Startup Factory.
          <br />
          <em>A Focused Builder Company.</em>
        </h2>
        <div className="philosophy-grid reveal" ref={gridRef}>
          ...
          <div className="philo-block">
            ...
            <p className="pb-text">
              Each product targets a specific vertical with a specific data
              problem that existing tools solve poorly. Weddings.
              Certifications. Entertainment. Party gaming. Niche markets with
              real pain and no dominant incumbents.
            </p>
          </div>
          <div className="philo-block">
            ...
            <p className="pb-text">
              I validate before I over-engineer. The goal of every product is a
              working version in the hands of real users as fast as possible.
              Feedback from real users beats assumptions from any amount of
              market research.
            </p>
          </div>
        </div>
  ...
  const steps = [
    {
      icon: "◎",
      label: "Identify",
      desc: "Find a vertical with a real data problem and no good existing solution",
    },
    {
      icon: "◈",
      label: "Validate",
      desc: "Confirm the pain is real before writing a line of code",
    },
    {
      icon: "⬡",
      label: "Architect",
      desc: "Design the data model, UX, and tech stack for the specific problem",
    },
    {
      icon: "△",
      label: "Ship",
      desc: "Deploy a working product using Lovable + Supabase stack",
    },
    {
      icon: "◻",
      label: "Iterate",
      desc: "Refine based on real user behavior, not assumptions",
    },
  ];
  return (
    <section className="build-model">
      <div className="build-inner">
        ...
        <h2>
          Same Five Moves.
          <br />
          <em>Every Product. Every Time.</em>
        </h2>
        ...
        <div className="model-proof reveal" ref={proofRef}>
          ...
          <div className="mp-text">
            This is the same motion I'd apply inside a portfolio company.{" "}
            <strong>
              Identify the highest-leverage problem. Validate the root cause.
              Architect the right solution. Ship something real.
            </strong>{" "}
  ...
  const products = [
    {
      ...
      outcomeVal: "PE",
      outcomeDesc:
        "Portfolio operations intelligence for private equity firms and their operating teams.",
    ...
    },
    {
      ...
      outcomeVal: "AI",
      outcomeDesc:
        "AI-assisted pricing intelligence. Subscription SaaS targeting under-served mid-market operators.",
      status: "In Development",
    },
    {
      ...
      outcomeVal: "AI",
      outcomeDesc:
        "AI menu engineering at a price point accessible to independent restaurant operators.",
      status: "In Beta",
    },
    {
      ...
      outcomeVal: "PE",
      outcomeDesc:
        "Built for private equity firms that need standardized AI ROI measurement across their portfolios.",
      status: "Live",
    },
  ];
    ...
    <section className="products">
      <div className="products-inner">
        ...
        <h2>
          Four Verticals.
          <br />
          <em>Four Real Problems Solved.</em>
        </h2>
        <p className="products-intro">
          Each product represents a different market, a different user, and a
          different data problem. The common thread: I built them all, shipped
          them all, and own every decision in each one.
        </p>
        {products.map((p) => (
    ...
    <div className="key-quote">
      <div className="kq-inner">
        <div className="kq-text">
          "When you build products with your own time and your own money, you
          have to ship things that actually work. There's no team to diffuse
          accountability onto. Every decision is yours. Every failure is yours.
          So is every win."
        </div>
        <div className="kq-attr">
          Jay Burgess · Founder & Principal Forward Deployed Engineer, Revuity
          Systems
        </div>
      </div>
    </div>
...
function WhatThisProves() {
  ...
  const proves = [
    ...
    {
      num: "02",
      title: "I Ship Fast Across Different Contexts",
      text: (
        <>
    ...
    {
      num: "03",
      title: "I Validate Before I Over-Build",
      text: (
        <>
          Every Revuity product starts with a real problem, not a cool
          technology. I identify the pain first, confirm it's real, then build
          the minimum version that solves it.{" "}
          <strong>
    ...
    {
      num: "04",
      title: "I Operate in Parallel at Scale",
      text: (
        <>
  ...
  return (
    <section className="cs-cta">
      <div className="cs-cta-inner">
        ...
        <p>
          Revuity Systems is what I build when there's no mandate to build it.
          Imagine what I'd ship with 20 companies, a team, and a mission behind
          it.
        </p>
        <a
