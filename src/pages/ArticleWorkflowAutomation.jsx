    ...
    <section className="article-hero">
      <div className="article-hero-inner">
        <div className="article-eyebrow">
          Article · Systems Design · April 2026
        </div>
        <h1 className="article-title">
          Workflow Automation Done Right: Why Most Automations Break and How to
          Build Ones That Don't
        </h1>
        <div className="article-abstract">
          ...
          variability, edge cases, and interface dependencies that define
          process behavior under real-world conditions. The automation works in
        ...
        <div className="article-meta-bar">
          ...
          <div className="article-meta-item">
            ...
            <div className="article-meta-val">Systems Design</div>
          </div>
          <div className="article-meta-item">
    ...
    <div className="article-body">
      <div className="article-section reveal" ref={r1}>
        ...
        <div className="article-prose">
          <p>
            The lifecycle of a fragile automation follows a recognizable arc.
            The automation is built against a specific, well-understood instance
            of the process it is replacing. It works reliably in that instance.
            It is declared a success. It is deployed to production. And then,
            over a period that varies from weeks to months depending on the
            variability of the real-world process, it begins encountering
            conditions it was not designed for.
          </p>
          <p>
            The inputs arrive in unexpected formats. The upstream system that
            the automation depends on changes its API. A business rule that the
      ...
      <div className="article-section reveal" ref={r2}>
        ...
        <div className="article-prose">
          <p>
            ...
            guidelines. Systems that violate them are fragile by design.
          </p>
        </div>
        <PrinciplesDiagram />
      </div>
      ...
      <div className="article-section reveal" ref={r3}>
        ...
        <div className="article-prose">
          <p>
            ...
            incorrectly designed when that interface changes, without any change
            to the automation itself.
          </p>
          <p>
            This is the interface problem in workflow automation: the system
            works correctly at build time and fails correctly at a later time
            without anyone having made a mistake. The interface changed. The
            automation didn't know. Nobody knew to update the automation. The
            failure surfaces when the automation processes real data under the
        ...
        <div className="article-pullquote">
          <p>
            "Automation that works perfectly in controlled conditions and breaks
            unpredictably in production is not robust automation. It is a
            liability wearing the appearance of an asset."
          </p>
        </div>
      </div>
      ...
      <div className="article-section reveal" ref={r4}>
        ...
        <div className="article-prose">
          <p>
            ...
            it produces wrong output, because it was not designed with a human
            handoff in mind.
          </p>
          <p>
      ...
      <div className="article-references">
        ...
        <ol>
          ...
          <li>
            Norman, D. A. (1988). <em>The Design of Everyday Things</em>. Basic
            Books.
          </li>
          <li>
            Winograd, T. &amp; Flores, F. (1986).{" "}
            <em>Understanding Computers and Cognition</em>. Ablex Publishing.
          </li>
          <li>
            Hollnagel, E. (2009).{" "}
            <em>The ETTO Principle: Efficiency-Thoroughness Trade-Off</em>.
            Ashgate Publishing.
          </li>
        </ol>
      </div>
