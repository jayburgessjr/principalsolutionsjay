    ...
    <section className="article-hero">
      <div className="article-hero-inner">
        <div className="article-eyebrow">
          Article · AI Architecture · April 2026
        </div>
        <h1 className="article-title">
          RAG Architecture in Practice: Building Retrieval Systems That Don't
          Lie
        </h1>
        ...
        <div className="article-meta-bar">
          ...
          <div className="article-meta-item">
            ...
            <div className="article-meta-val">AI Architecture</div>
          </div>
          <div className="article-meta-item">
...
const RAG_LAYERS = [
  ...
  },
  {
    ...
    desc: "The transformation of raw documents into retrievable embeddings. Chunking granularity, embedding model selection, and index maintenance are all architectural decisions with significant retrieval quality implications.",
    accent: false,
  },
  {
    label: "Layer 3",
  ...
  },
  {
    ...
    desc: "The construction of the prompt context from retrieved documents. Deduplication, relevance ordering, token budget management, and citation attachment all operate here. Context assembly quality directly determines generation quality.",
    accent: false,
  },
  {
    label: "Layer 5",
...
function RAGDiagram() {
  return (
    <div className="article-diagram">
          ...
          >
            <div
              style={{
                ...
                color: l.accent ? "var(--orange)" : "var(--dim)",
                flexShrink: 0,
                paddingTop: "0.15rem",
              }}
            >
            ...
            <div>
              <div
                style={{
                  fontSize: "0.9rem",
                  fontWeight: 600,
                  color: l.accent ? "var(--orange)" : "var(--white)",
      ...
      >
        Layer 3 (highlighted) is the binding constraint in the majority of
        enterprise RAG failures. Most optimization effort is incorrectly applied
        to Layer 5.
      </div>
    </div>
  );
    ...
    <div className="article-body">
      <div className="article-section reveal" ref={r1}>
        ...
        <div className="article-prose">
          <p>
            The promise of RAG is constraint: by providing the model with
            retrieved documents, you constrain its generation to information you
            have verified. In practice, this constraint is weaker than it
          ...
          <p>
            ...
            hallucinated." It is "the retrieval returned the wrong documents,
            and the model did what it was designed to do with them." The locus
            of failure is the retrieval layer. The solution is retrieval
            architecture, not model prompting.
          </p>
        </div>
      </div>
      ...
      <div className="article-section reveal" ref={r2}>
        ...
        <div className="article-prose" style={{ marginTop: "1.5rem" }}>
          <p>
            ...
            systems, not the layer where quality is being lost. Quality is being
            lost at Layer 3, in retrieval precision, and at Layer 1, in
            knowledge architecture. Optimizing Layer 5 while underinvesting in
            Layers 1 and 3 is the defining pattern of underperforming enterprise
            RAG systems.
          </p>
        </div>
      </div>
      ...
      <div className="article-section reveal" ref={r3}>
        ...
        <div className="article-prose">
          <p>
            ...
            no amount of prompt engineering will raise.
          </p>
          <p>
          ...
          <p>
            <strong>Chunking strategy</strong> determines the granularity at
            which knowledge is retrievable. Chunks that are too large return
            context that contains the relevant information but dilutes it with
          ...
          <p>
            <strong>Metadata schema</strong> enables retrieval filtering that
            semantic search alone cannot provide. Date ranges, document types,
      ...
      <div className="article-section reveal" ref={r4}>
        ...
        <div className="article-prose">
          ...
          <p>
            Measuring retrieval precision requires evaluating retrieval
            independently from generation. For a representative query set,
            retrieve the top-k documents and evaluate relevance manually or with
            a separate evaluation model. The result is typically surprising to
            organizations that have not done this evaluation: retrieval
            precision at the query types that matter most is frequently below
            what the system's generation quality would suggest.
          </p>
          <p>
        ...
        <div className="article-pullquote">
          <p>
            "Measure retrieval at the document level, not the answer level. A
            system that retrieves the wrong documents and generates a fluent
            wrong answer will pass answer-level evaluation and fail your users."
          </p>
        </div>
      </div>
      ...
      <div className="article-section reveal" ref={r5}>
        ...
        <div className="article-prose">
          <p>
            ...
            weak retrieval precision are building systems where the last defense
            is doing the work of three upstream layers.
          </p>
          <p>
            Effective guardrails in enterprise RAG systems share three
            properties. They are explicit about scope: the model is told
            precisely what it is and is not authorized to answer, and what it
            must do when a query falls outside that scope. They require
            citation: responses must reference the specific retrieved documents
            they draw from, making quality auditable rather than assumed. And
            they escalate gracefully: when the system cannot answer reliably
            from its retrieved context, it produces a defined fallback response
  ...
  return (
    <section className="cs-cta">
      <h3>
        ...
        <br />
        <span>that needs to be trusted?</span>
      </h3>
      <p>
