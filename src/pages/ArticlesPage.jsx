...
const ALL_ARTICLES = [
  ...
  },
  {
    ...
    abstract:
      "Data debt is not a storage problem. It is a decision-making problem that compounds silently until a strategic decision fails for lack of reliable information.",
  },
  {
  ...
  },
  {
    ...
    abstract:
      "The standard build vs. buy analysis is systematically biased. A five-dimension framework that accounts for the full cost topology of each option.",
  },
  {
  ...
  },
  {
    ...
    abstract:
      "Technical due diligence is performed too late, too narrowly, or too optimistically. A four-domain framework for evaluations that find what comfortable ones miss.",
  },
  {
    ...
    abstract:
      "Conway's Law as a leadership tool: how team structure determines system quality and the most powerful lever available to technical leaders.",
  },
  {
  ...
  },
  {
    ...
    abstract:
      "Prompt engineering is necessary but insufficient. The four layers of AI system design that determine whether investment generates production value.",
  },
  {
    ...
    <>
      ...
      >
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <h1 className="articles-heading" style={{ marginBottom: "0.75rem" }}>
            All Articles
          </h1>
