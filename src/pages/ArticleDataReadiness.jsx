    ...
    <section className="article-hero">
      <div className="article-hero-inner">
        <div className="article-eyebrow">
          Article · Data Infrastructure · May 2026
        </div>
        ...
        <div className="article-meta-bar">
          ...
          <div className="article-meta-item">
            ...
            <div className="article-meta-val">May 2026</div>
          </div>
          <div className="article-meta-item">
...
const SIGNALS = [
  {
    signal: "Data is in spreadsheets updated manually by individuals",
    implication:
      "Accessibility failure. No programmatic access at inference latency.",
  },
  {
    signal: "Different teams report different numbers for the same metric",
    implication:
      "Quality failure. No single source of truth; ground truth is undefined.",
  },
  {
    signal: '"We\'re not sure who owns that data anymore"',
    implication:
      "Governance failure. Degradation is unmonitored and already in progress.",
  },
  {
    signal: "Historical data reflects old processes, not current ones",
    implication:
      "Coverage failure. AI trained on it will encode obsolete behavior.",
  },
  {
    signal: "Data lives in a system the AI cannot access without an export",
    implication:
      "Accessibility failure. Exports at inference time are not a production architecture.",
  },
  {
    signal: 'Fields are sometimes empty, sometimes null, sometimes "N/A"',
    implication:
      "Quality failure. Inconsistent representation requires compensating logic at every consumer.",
  },
];
    ...
    <div className="article-diagram">
      ...
      >
        ...
        {SIGNALS.map((s, i) => (
          <div
            key={i}
            style={{ display: "flex", gap: "1px", background: "var(--rule)" }}
          >
            <div
              style={{
                flex: 1,
    ...
    <div className="article-body">
      <div className="article-section reveal" ref={r1}>
        ...
        <div className="article-prose">
          <p>
            The post-mortem for a failed AI project almost always identifies the
          ...
          <p>
            This is not an oversight. It is a structural feature of how AI
            investment decisions are made. The business case for an AI project
          ...
          <p>
            The consequence is a consistent pattern: organizations approve AI
            projects on the strength of the use case, discover data readiness
            failures during implementation, spend the majority of the project
            timeline and budget on data remediation work that was not scoped,
            and deliver either a degraded system or no system at all. The
            project is described as an AI failure. It was a data readiness
            failure that was never diagnosed because no one ran the test before
      ...
      <div className="article-section reveal" ref={r2}>
        ...
        <div className="article-prose">
          <p>
            Data readiness is not a single variable. An organization can have
      ...
      <div className="article-section reveal" ref={r3}>
        ...
        <div className="article-prose">
          <p>
            Data readiness failures announce themselves before a project begins
      ...
      <div className="article-section reveal" ref={r4}>
        ...
        <div className="article-prose">
          <p>
            Minimum viable data readiness is not perfect data. It does not
            require a fully mature data platform, a complete data catalog, or
            enterprise-grade governance across all domains. It requires four
            conditions to be true for the specific data sources that the
            proposed AI use case will depend on.
          </p>
          <p>
            <strong>Programmatic accessibility at inference latency.</strong>{" "}
            The data can be queried or retrieved by the AI system at the speed
            required for the use case. If the use case requires real-time
          ...
          <p>
            <strong>
              Documented quality standards with known defect rates.
            </strong>{" "}
            The organization knows what the data is supposed to contain, has
            measured how frequently it diverges from that standard, and has
            documented the compensation logic that downstream systems apply to
            handle the divergence. Unknown defect rates are more dangerous than
            known high defect rates, because known defect rates can be designed
            around and high defect rates can be disclosed as a constraint.
            Unknown defect rates produce systems that are wrong in ways that
            cannot be anticipated or mitigated.
          </p>
          <p>
            <strong>An identified owner accountable for data accuracy.</strong>{" "}
            A specific person or team is responsible for the quality of each
            data source the AI will depend on, has the authority to correct
            errors in that source, and is aware that an AI system will be
            depending on their data's accuracy. This last condition is more
            important than it sounds: data owners who do not know that an AI
            system depends on their data do not factor AI-level quality
            requirements into their maintenance behavior.
          </p>
          <p>
            <strong>
            ...
            situations with sufficient frequency and accuracy.
          </p>
        </div>
        <div className="article-pullquote">
          <p>
            "The most expensive data work is data work that was not scoped
            because no one ran the readiness assessment before the project
            started. The second most expensive is data work that was scoped but
      ...
      <div className="article-section reveal" ref={r5}>
        ...
        <div className="article-prose">
          <p>
            The most valuable output of a data readiness assessment is sometimes
          ...
          <p>
            ...
            Only one of them arrives there efficiently.
          </p>
          <p>
      ...
      <div className="article-references">
        ...
        <ol>
          ...
          <li>
            ...
            <em>DAMA-DMBOK: Data Management Body of Knowledge</em> (2nd ed.).
            Technics Publications.
          </li>
          <li>
            Sculley, D. et al. (2015). Hidden Technical Debt in Machine Learning
            Systems.{" "}
            <em>Advances in Neural Information Processing Systems 28</em>.
          </li>
          <li>
            Stonebraker, M. &amp; Ilyas, I. (2018). Data Integration: The
          ...
          <li>
            ...
            not the data work."{" "}
            <em>CHI Conference on Human Factors in Computing Systems</em>.
          </li>
        </ol>
      </div>
    </div>
