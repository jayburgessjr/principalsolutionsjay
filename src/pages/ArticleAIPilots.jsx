    ...
    <section className="article-hero">
      <div className="article-hero-inner">
        <div className="article-eyebrow">
          Article · AI Strategy · April 2026
        </div>
        <h1 className="article-title">
          Why AI Pilots Die Before Production: The Organizational Gaps That Kill
          Good Projects
        </h1>
        <div className="article-abstract">
          ...
          the evaluation criteria used to assess whether it succeeded. This
          paper identifies five gaps, explains their structural origins, and
          proposes an evaluation framework that closes the distance between
          pilot success and production value before the pilot begins.
        </div>
        <div className="article-meta-bar">
          ...
          <div className="article-meta-item">
            ...
            <div className="article-meta-val">AI Strategy</div>
          </div>
          <div className="article-meta-item">
    ...
    <div className="article-body">
      <div className="article-section reveal" ref={r1}>
        ...
        <div className="article-prose">
          <p>
            An organization runs an AI pilot. The model achieves target
            accuracy. The stakeholder demo generates genuine enthusiasm. The
            final report declares success. Six months later, the system is not
            in production. A year later, a new pilot is approved for a different
            problem.
          </p>
          <p>
          ...
          <p>
            ...
            both pilot design and pilot success criteria.
          </p>
        </div>
      </div>
      ...
      <div className="article-section reveal" ref={r2}>
        ...
        <div className="article-prose">
          <p>
            The five gaps below are not theoretical. They are patterns observed
            across organizations that have run technically successful pilots
            that did not reach production. Each is organizational rather than
            technical. Each is diagnosable before the pilot begins. And each is
            fully addressable if it is recognized as a requirement rather than
            an afterthought. Select any gap to expand.
          </p>
        </div>
        <GapCards />
      </div>
      ...
      <div className="article-section reveal" ref={r3}>
        ...
        <div className="article-prose">
          <p>
            Pilots are designed to answer the question "can this work?" That is
            the wrong question. The right question is "can this work, in our
            environment, with our data, within our operational processes, at the
            quality threshold required, with the people we have, under the
            failure conditions we will encounter?" Pilots that answer only the
            first question generate knowledge about what is technically
            possible. They do not generate knowledge about what is operationally
            achievable.
          </p>
          <p>
            The incentive structure of pilot design reinforces this narrowing.
            Pilots are approved by budget owners who need to see evidence of
            capability. They are designed by technical teams who are best
          ...
          <p>
            ...
            organizational gaps that prevent production deployment are genuinely
            outside the scope of most pilot designs, and no amount of technical
            success fills them.
          </p>
        </div>
        <div className="article-pullquote">
          <p>
            "A pilot answers whether the technology can work. Production
            requires evidence that the organization can work with the
            technology. These are different questions with different evaluation
            criteria."
          </p>
        </div>
      </div>
      ...
      <div className="article-references">
        ...
        <ol>
          <li>
            Davenport, T. H. &amp; Mittal, N. (2023).{" "}
            <em>
              All-in on AI: How Smart Companies Win Big with Artificial
              Intelligence
            </em>
          ...
          <li>
            ...
            <em>Machine Platform Crowd: Harnessing Our Digital Future</em>. W.
            W. Norton.
          </li>
          <li>
            Kotter, J. P. (1996). <em>Leading Change</em>. Harvard Business
            School Press.
          </li>
          <li>
          ...
          <li>
            Ng, A. (2022). MLOps: From Model-centric to Data-centric AI.{" "}
            <em>DeepLearning.AI Technical Report</em>.
          </li>
        </ol>
      </div>
    </div>
...
function ArticleCTA() {
  return (
    <section className="cs-cta">
      ...
      <p>
        I diagnose the organizational gaps, design the path to production, and
        build the architecture that closes it. Let's talk.
      </p>
      <a
