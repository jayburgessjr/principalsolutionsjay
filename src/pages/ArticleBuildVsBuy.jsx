    ...
    <section className="article-hero">
      <div className="article-hero-inner">
        ...
        <h1 className="article-title">
          Build vs. Buy in AI Infrastructure: A Decision Framework That Doesn't
          Lie to You
        </h1>
    ...
    <div className="maturity-spectrum">
      ...
      {DIMENSIONS.map((d, i) => (
        ...
        >
          ...
          >
            <div
              style={{ flex: 1, background: "var(--black)", padding: "1rem" }}
            >
              <div
                style={{
            ...
            <div
              style={{ flex: 1, background: "var(--panel)", padding: "1rem" }}
            >
              <div
                style={{
                  fontFamily: "IBM Plex Mono, monospace",
    ...
    <div className="article-body">
      <div className="article-section reveal" ref={r1}>
        ...
        <div className="article-prose">
          <p>
            The standard build vs. buy analysis compares two cost estimates: the
            internal development cost to build the capability, and the vendor
            licensing cost to buy it. The analysis then applies a time horizon
            and a discount rate, and the option with lower net present cost
            wins. This is a financially literate approach to a question that is
          ...
          <p>
            ...
            about the factors that matter most.
          </p>
          <p>
            This bias is not random. Build cost estimates are prepared by
            engineers who have incentives to make builds sound achievable and
            who work in organizations that have incentives to appear technically
            capable. Vendor cost estimates are prepared by sales teams who have
            incentives to minimize perceived total cost. The standard analysis
            aggregates two systematically biased inputs and produces a
            conclusion that reflects those biases more than the underlying
            economics.
          </p>
        </div>
      </div>
      ...
      <div className="article-section reveal" ref={r3}>
        ...
        <div className="article-prose">
          <p>
            Build analyses consistently undercount three costs:{" "}
            <strong>integration complexity</strong>, which is frequently equal
            to or greater than the build cost of the system itself;{" "}
            <strong>maintenance overhead</strong>, which tends to grow as the
      ...
      <div className="article-section reveal" ref={r4}>
        ...
        <div className="article-prose">
          ...
          <p>
            Buy decisions are made reversible through data portability
            requirements negotiated at contract time, through avoiding deep
            integration with vendor-proprietary APIs, and through maintaining
            internal architectural documentation sufficient to rebuild if
            necessary. Build decisions are made reversible through clean
            interface design, through avoiding dependencies that make vendor
            alternatives impractical, and through honest ongoing evaluation of
            whether the build continues to justify its maintenance cost.
          </p>
          <p>
            The organizations that manage this decision well share a common
      ...
      <div className="article-references">
        ...
        <ol>
          <li>
            ...
            Revolution. <em>Harvard Business Review</em>, 90(10), 60–68.
          </li>
          <li>
            Coase, R. H. (1937). The Nature of the Firm. <em>Economica</em>,
            4(16), 386–405.
          </li>
          <li>
            Simon, H. A. (1955). A Behavioral Model of Rational Choice.{" "}
            <em>Quarterly Journal of Economics</em>, 69(1), 99–118.
          </li>
          <li>
            Vendor Lock-in and Software Ecosystems. (2021).{" "}
            <em>IEEE Software Engineering Body of Knowledge (SWEBOK)</em>.
          </li>
          <li>
            Kim, G. et al. (2016). <em>The DevOps Handbook</em>. IT Revolution
            Press.
          </li>
        </ol>
      </div>
