    ...
    <section className="article-hero">
      <div className="article-hero-inner">
        <div className="article-eyebrow">
          Article · Agentic Systems · May 2026
        </div>
        ...
        <div className="article-abstract">
          ...
          architecture pattern, because agentic systems fail in compounding ways
          that are nearly impossible to surface in controlled evaluation. This
          paper identifies five architectural failure patterns specific to
          agentic systems, examines why the standard build sequence for
          multi-agent development produces them, and proposes a sequenced
          approach to agentic architecture that closes the gap before it becomes
        ...
        <div className="article-meta-bar">
          ...
          <div className="article-meta-item">
            ...
            <div className="article-meta-val">Agentic Systems</div>
          </div>
          <div className="article-meta-item">
...
function SequenceDiagram() {
  return (
    <div className="article-diagram">
          ...
          >
            <div
              style={{
                ...
                color: row.wrong ? "rgba(232,98,26,0.5)" : "var(--orange)",
                flexShrink: 0,
                width: "90px",
                paddingTop: "0.3rem",
              }}
      ...
      >
        The wrong order builds the interface before defining the task boundary.
        The failure modes are architectural from the first commit.
      </div>
    </div>
  );
}
  ...
  return (
    <div className="article-body">
      <div className="article-section reveal" ref={r1}>
        ...
        <div className="article-prose">
          <p>
            ...
            significantly wider for agentic systems than for any other AI
          ...
          <p>
            ...
            confident-looking failures at production scale, in systems that
      ...
      <div className="article-section reveal" ref={r2}>
        ...
        <div className="article-prose">
          <p>
            Agentic demos succeed for three structural reasons that disappear in
            production. <strong>Scripted inputs:</strong> demos are run with
          ...
          <p>
            <strong>Short task horizons:</strong> demo tasks complete in two to
          ...
          <p>
            ...
            being built on corrupted intermediate state. The demo worked. The
            failure handling was never tested. Production discovered both facts
            simultaneously.
          </p>
        </div>
        <div className="article-pullquote">
          <p>
            "An agentic system that works in a demo is a system that has not yet
            encountered the conditions under which it will fail. In production,
            those conditions arrive on day one."
          </p>
        </div>
      </div>
      ...
      <div className="article-section reveal" ref={r4}>
        ...
        <div className="article-prose">
          <p>
            ...
            pre-deployment check. This sequence produces systems that are
            architecturally fragile from the first commit, because the
            fundamental questions of task boundary, tool selection logic, and
            failure handling are answered implicitly by implementation decisions
            rather than explicitly by architectural decisions.
          </p>
        </div>
        <SequenceDiagram />
        <div className="article-prose" style={{ marginTop: "1.5rem" }}>
          <p>
            ...
            provides, what are the valid input forms, and what does failure look
            like. Single-agent validation then verifies that each agent in the
            system performs its isolated function correctly before orchestration
            is introduced.
          </p>
          <p>
      ...
      <div className="article-section reveal" ref={r5}>
        ...
        <div className="article-prose">
          ...
          <p>
            <strong>Explicit failure handling at every decision point.</strong>{" "}
          ...
          <p>
            <strong>
              Context budget management as a first-class architectural concern.
            </strong>{" "}
          ...
          <p>
            ...
            documented signal under adversarial inputs.
          </p>
          <p>
            <strong>
              Path-sampled evaluation, not output-sampled evaluation.
            </strong>{" "}
        ...
        <div className="article-pullquote">
          <p>
            "The question is not whether your agentic system produces correct
            outputs in a demo. The question is whether it produces correct
            outputs reliably across the execution path space that your users
            will explore on day one."
          </p>
        </div>
        <div className="article-prose">
          <p>
            Agentic systems built to these four requirements are more expensive
            to build than demo-ready agentic systems. They are substantially
            less expensive than the remediation cycles that follow when
      ...
      <div className="article-references">
        ...
        <ol>
          <li>
            ...
            Language Models. <em>arXiv:2210.03629</em>.
          </li>
          <li>
            Park, J. et al. (2023). Generative Agents: Interactive Simulacra of
            Human Behavior. <em>arXiv:2304.03442</em>.
          </li>
          <li>
          ...
          <li>
            ...
            <em>Anthropic Engineering Blog</em>.
          </li>
          <li>
            Burgess, J. (2025).{" "}
            <em>
              Agentic Engineering: Building Autonomous AI Systems That Actually
              Work
            </em>
  ...
  return (
    <section className="cs-cta">
      <h3>
        ...
        <br />
        <span>that needs to ship?</span>
      </h3>
      <p>
        I architect and build agentic AI systems for organizations where
        reliable production behavior is not optional. If you're navigating the
        gap between demo and production, let's talk.
      </p>
      <a
