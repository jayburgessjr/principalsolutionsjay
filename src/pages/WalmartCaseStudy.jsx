    ...
    <section className="cs-hero">
      ...
      <div className="cs-inner">
        <div className="cs-eyebrow">
          Case Study · Enterprise Transformation · Fortune 1
        </div>
        <h1 className="cs-title">
          <span style={{ color: "var(--dim)" }}>Walmart</span>
          <br />
          <span className="orange">Creative</span>
          <br />
          Operations
        </h1>
        ...
        <div className="cs-meta-bar">
          ...
          <div className="cs-meta-item">
            ...
            <div className="cmi-val">
              No data department. No infrastructure. Spreadsheets only.
            </div>
          </div>
          <div className="cs-meta-item">
            <div className="cmi-label">Outcome</div>
            <div className="cmi-val">
              37% improvement in project completion · Full data org built
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="cs-section-inner">
        ...
        <div className="situation-grid reveal" ref={ref}>
          <div className="situation-prose">
            ...
            <p>
              The division was generating enormous volumes of operational and
            ...
            <p>
              ...
              <strong>
                work stalled and inefficiency compounded in every direction.
              </strong>{" "}
              Assets were being misallocated. Costs per unit were being
              estimated by gut instinct. Production decisions were made without
              any forecast of what they'd actually cost or save. When I arrived,
              leadership couldn't answer basic questions like "how much does
              this creative asset cost us to produce across the full lifecycle?"
              because the data to answer it didn't exist in any usable form.
            </p>
            <p>
          ...
          <div>
            <div className="chaos-box">
              ...
              <div className="chaos-text">
                ...
                version control, no single source of truth.
              </div>
            </div>
            <div className="chaos-box">
            ...
            <div className="chaos-box">
              ...
              <div className="chaos-text">
                Data strategy. Data engineering. Governance. Visualization.
                Predictive modeling. Organizational alignment.{" "}
                <strong>All of it. From scratch.</strong>
              </div>
            </div>
          </div>
        </div>
...
function WhatIBuilt() {
  ...
  const builtItems = [
    ...
    },
    {
      ...
      desc: (
        <>
          ...
          <strong>
            One source of truth, replacing hundreds of disconnected files.
          </strong>
        </>
      ),
    },
    {
      num: "03",
      title: "Asset & Cost Forecasting Algorithms",
      desc: (
        <>
    ...
    },
    {
      ...
      desc: (
        <>
          {" "}
          Built machine learning models for predictive scenario analysis:{" "}
          <strong>
            "If we make this production decision, how much will it cost vs. save
            over the next two quarters?"
          </strong>{" "}
          Converted gut-instinct decisions into quantified, defensible
          recommendations.
        </>
      ),
    },
  ...
  const algoBlocks = [
    ...
    },
    {
      ...
      desc: "Connected cost data to pricing decisions, surfacing where the division was underpricing, overproducing, or misallocating resources relative to actual market and internal benchmarks.",
    },
  ];
  const councilBlocks = [
    {
    ...
    {
      step: "Purpose",
      title: "Shared Ownership of Data",
      desc: "Data governance can't be a top-down mandate. By making team leaders co-architects of the governance model, adoption happened organically.",
    },
    {
      step: "Outcome",
    ...
    <section className="cs-section" style={{ background: "var(--panel)" }}>
      <div className="cs-section-inner">
        ...
        <h2 className="cs-section-h2">
          Not a Dashboard.
          <br />
          <em>An Entire Data Organization.</em>
        </h2>
    ...
    <div className="key-quote">
      <div className="kq-inner">
        ...
        <div className="kq-attr">
          Jay Burgess · Data Architect, Walmart Creative Operations
        </div>
      </div>
    </div>
  );
...
function Outcomes() {
  ...
  const outcomes = [
    ...
    {
      num: "3",
      label: "Quarters to Impact",
      desc: "From zero infrastructure to quantified, attributable financial impact in nine months. No inherited systems. No data team. Built from scratch.",
    },
    {
      num: "0→1",
  ...
  const details = [
    {
      label: "Where the Bottlenecks Were Hiding",
      title: "Invisible Operational Drag",
      desc: "Without structured tracking, projects stalled and resources were misallocated in ways no one could see. The anomaly-detection models surfaced where workflows were breaking down and where production decisions were systematically over-investing in low-return work and under-investing in high-return work.",
    },
    {
    ...
    <section className="cs-section">
      <div className="cs-section-inner">
        ...
        <h2 className="cs-section-h2">
          ...
          <br />
          <em>Three Quarters. One Division.</em>
        </h2>
        <p className="method-intro">
          The results weren't theoretical. They were quantified, tracked, and
          attributable to specific architectural decisions and algorithmic
          interventions.
        </p>
