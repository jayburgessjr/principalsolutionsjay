    ...
    <section className="article-hero">
      <div className="article-hero-inner">
        ...
        <div className="article-abstract">
          ...
          before evaluating the vendor's operational track record at their
              ...
              {d.questions.map((q, qi) => (
                <li
                  ...
                  style={{
                    ...
                    lineHeight: 1.7,
                    paddingLeft: "1rem",
                    borderLeft: "2px solid var(--rule2)",
                  }}
                >
                  {q}
                </li>
    ...
    <div className="article-body">
      <div className="article-section reveal" ref={r1}>
        ...
        <div className="article-prose">
          ...
          <p>
            The second is access: evaluators see the architecture the team wants
            to present, not the architecture that actually runs in production.
            Demo environments are clean. Production environments accumulate
            workarounds, undocumented dependencies, and informal architectural
            decisions that exist nowhere in the official documentation. The most
            important due diligence conversations happen not with the
            engineering leadership team, but with the engineers who maintain the
            system at 2am when it breaks.
          </p>
          <p>
            The third is incentive alignment: both parties to the evaluation
      ...
      <div className="article-section reveal" ref={r2}>
        ...
        <div className="article-prose">
          <p>
            Effective technical due diligence covers four domains, each of which
            surfaces a different category of risk. The questions below are
            designed to produce evidence-based answers rather than qualitative
            assurances. Select each domain to see the key evaluation questions
            and the primary risk it surfaces.
          </p>
        </div>
        <DomainCards />
      </div>
      ...
      <div className="article-section reveal" ref={r3}>
        ...
        <div className="article-prose">
          <p>
            ...
            Show me the deployment process in the actual environment. What would
            you rewrite if you were starting over? Where do you have the most
            technical debt that you haven't been able to address?
          </p>
          <p>
        ...
        <div className="article-pullquote">
          <p>
            "The most important question in technical due diligence is not 'what
            does this system do?' It is 'what does this system do when it
            breaks, at 2am, under production load, with the person who built it
            unavailable?'"
          </p>
        </div>
      </div>
        ...
        <div className="article-prose">
          <p>
           ...
           , the capability that exists, the problems that are present, the
            ...
            ensure that every yes is made with eyes open.
          </p>
          <p>
      ...
      <div className="article-references">
        ...
        <ol>
          <li>
            Lajoux, A. R. &amp; Elson, C. M. (2010).{" "}
            <em>The Art of M&A Due Diligence</em> (2nd ed.). McGraw-Hill.
          </li>
          <li>
            McConnell, S. (2004). <em>Code Complete</em> (2nd ed.). Microsoft
            Press.
          </li>
          <li>
          ...
          <li>
            ...
            <em>Software Architecture in Practice</em> (3rd ed.).
            Addison-Wesley.
          </li>
        </ol>
      </div>
  ...
  return (
    <section className="cs-cta">
      <h3>
        Making a technical
        <br />
        <span>commitment you need to trust?</span>
      </h3>
      <p>
        I perform technical due diligence that finds the problems that
        comfortable evaluations miss. Let's talk about what you're evaluating.
      </p>
      <a
