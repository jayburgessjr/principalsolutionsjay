    ...
    <section className="article-hero">
      <div className="article-hero-inner">
        ...
        <h1 className="article-title">
          The Org Chart Is the Architecture: How Team Structure Determines
          System Quality
        </h1>
        <div className="article-abstract">
          ...
          domains, managed by different people with different objectives on
          different timelines. This paper argues that they are the same problem,
          that architectural decisions made without organizational design
    ...
    <div className="article-body">
      ...
      <div className="article-section reveal" ref={r4}>
        ...
        <div className="article-prose">
          ...
          <p>
            <strong>
              Design the team topology before the component topology.
            </strong>{" "}
          ...
          <p>
            <strong>
              Use architectural decisions to create organizational forcing
              functions.
            </strong>{" "}
            ...
            is not just a technical artifact. It is an organizational boundary
            that determines how teams relate to each other.
          </p>
        </div>
      </div>
      ...
      <div className="article-section reveal" ref={r5}>
        ...
        <div className="article-prose">
          <p>
            ...
            organizational leadership. Crossing that boundary requires both the
            standing to make the argument and the vocabulary to make it in terms
            that organizational leaders find relevant.
          </p>
          <p>
            The vocabulary exists. Conway's Law provides it. The translation is
            direct: the systems we build will mirror the communication
      ...
      <div className="article-references">
        ...
        <ol>
          <li>
            Conway, M. E. (1968). How Do Committees Invent? <em>Datamation</em>,
            14(4), 28–31.
          </li>
          <li>
            Skelton, M. &amp; Pais, M. (2019).{" "}
            <em>
          ...
          <li>
            Newman, S. (2015). <em>Building Microservices</em>. O'Reilly Media.
          </li>
          <li>
            MacCormack, A., Rusnak, J. &amp; Baldwin, C. Y. (2012). Exploring
            the Duality Between Product and Organizational Architectures.{" "}
            <em>Research Policy</em>, 41(8), 1309–1324.
          </li>
          <li>
            Forsgren, N., Humble, J. &amp; Kim, G. (2018). <em>Accelerate</em>.
            IT Revolution Press.
          </li>
        </ol>
      </div>
  ...
  return (
    <section className="cs-cta">
      <h3>
        ...
        <br />
        <span>that are really org problems?</span>
      </h3>
      <p>
