...
const FEATURED = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        desc: "Know where your pricing sits relative to the market in real time. Stop leaving margin on the table.",
      },
      {
        label: "Market Heat Index",
        desc: "Composite signal combining permit velocity, competitive density, and pricing movement into a single weekly read.",
      },
    ],
    href: null,
    ...
    features: [
      {
        ...
        desc: "ML models trained on comparable titles, distribution channels, and market conditions to forecast commercial range before greenlight.",
      },
      {
      ...
      },
      {
        ...
        desc: "Model how specific cast and crew combinations affect projected performance based on historical comparable data.",
      },
    ],
    href: null,
    accentColor: "var(--orange)",
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        desc: "See your full menu ranked by contribution margin. Identify the underperformers that look busy but drain the bottom line.",
      },
      {
...
const CATALOG = [
  {
    ...
    price: "$29/mo",
    vertical: "Creative & Film Tools",
    desc: "The social media and marketing director filmmakers use to dominate their campaigns.",
    status: "Live",
    href: null,
  },
  {
  ...
  },
  {
    ...
    price: "$49/mo",
    vertical: "Business Intelligence",
    desc: "The pricing intelligence platform for small businesses and nonprofits.",
    status: "Early Access",
    href: null,
  },
  {
    name: "The Bible Soul Guide",
    price: "$9/mo",
    vertical: "Faith & Wellbeing",
    desc: "AI-powered Bible study companion with personal devotionals and scholarly context.",
    status: "Live",
    href: null,
  },
  {
    name: "GameNightz Online",
    price: "Free",
    vertical: "Games & Play",
    desc: "8 party games, zero downloads. Players join instantly on their phones.",
    status: "Live",
    href: null,
  },
];
    ...
    <section className="cs-hero">
      ...
      <div className="cs-inner">
        <div className="cs-eyebrow">
          Revuity Systems · Product Catalog · 8 Independent Products
        </div>
        <h1 className="cs-title">
          <span style={{ color: "var(--dim)" }}>Revuity</span>
          <br />
          <span className="orange">Products</span>
        </h1>
        <p className="cs-subtitle">
          Eight independent products. Five verticals. Each one built to run
          without you.
        </p>
        <p className="cs-desc">
          Vertical Data Intelligence. Creative & Film Tools. Games & Play. Faith
          & Wellbeing. Business Intelligence. Every product is scoped to a
          specific market problem, architected for autonomous operation, and
          priced for recurring revenue from day one.
        </p>
        <div className="cs-meta-bar">
          <div className="cs-meta-item">
            <div className="cmi-label">Company</div>
          ...
          <div className="cs-meta-item">
            ...
            <div className="cmi-val">
              Data Intelligence · Film · Games · Faith · Business
            </div>
          </div>
          <div className="cs-meta-item">
            <div className="cmi-label">Model</div>
            <div className="cmi-val">
              Recurring SaaS · Free → $199/mo · Built to run without you
            </div>
          </div>
        </div>
      </div>
  ...
  const content = (
    <>
      <div className="catalog-card-top">
        ...
        <div
          className={`catalog-card-status ${product.status === "Live" ? "live" : ""}`}
        >
          {product.status}
        </div>
      </div>
...
function FeaturedProduct({ product, index, flip }) {
  ...
  return (
    <section
      ...
      style={{ background: index % 2 === 1 ? "var(--panel)" : undefined }}
    >
  ...
  return (
    <section className="cs-cta">
      <div className="cs-cta-inner">
        ...
        <Link to="/revuity-case-study" className="btn-ghost">
          Revuity Case Study →
        </Link>
      </div>
    </section>
