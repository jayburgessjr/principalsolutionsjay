...
const tools = [
  {
    ...
    description:
      "A weighted, rubric-driven scoring system for evaluating AI outputs in regulated environments. 5 dimensions. 7 failure pattern tags. Composite 0–100 score.",
    features: [
      "5 Evaluation Dimensions",
      "7 Failure Pattern Tags",
  ...
  },
  {
    ...
    description:
      "15 structured test cases designed to stress-test compliance AI systems, from routine lookups to out-of-scope traps. Built on the Burgess Evaluation Framework.",
    features: [
      "Routine Compliance Lookups",
      "Out-of-Scope Traps",
      "Edge Case Scenarios",
    ],
    ...
    <section className="methodology" id="methodology">
      <div className="methodology-inner">
        ...
        <p className="method-intro">
          The evaluation frameworks I built to QA production AI in regulated
          environments, now available as interactive tools.
        </p>

        <div
          className="proof-grid reveal"
          ref={gridRef}
