    ...
    <>
      <div className="case-band">
        <div className="case-band-text">
          ...
          <p>
            Each built to run without ongoing maintenance. See the full company.
          </p>
        </div>
        <Link to="/revuity-products" className="case-band-link">
          See All 8 Products →
        </Link>
      </div>
